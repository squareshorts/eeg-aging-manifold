...
The analysis code, including EEG feature extraction, model fitting, trajectory projection, longitudinal analyses, and figure generation, will be made available in a public repository before submission. The repository URL will be inserted in the final submitted version.
